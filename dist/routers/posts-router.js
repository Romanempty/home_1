...
const valPost_5 = require("../midlewaress/valPost");
...
exports.postRouter.post('/', valMiddlewire_1.authorizationVal, valPost_1.postTitleVal, valPost_2.postShortDescriptionVal, valPost_3.postContentVal, valPost_4.postBlogIdVal, valPost_5.postBlogName, valMiddlewire_2.inputValidationMidldewareErrors, (req, res) => {
...
exports.postRouter.put('/:id', valMiddlewire_1.authorizationVal, valPost_1.postTitleVal, valPost_2.postShortDescriptionVal, valPost_3.postContentVal, valPost_4.postBlogIdVal, valPost_5.postBlogName, valMiddlewire_2.inputValidationMidldewareErrors, (req, res) => {
